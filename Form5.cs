...
namespace PhamacyManagementSystem
{
    public partial class payment : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'myDatabaseProjectDataSet.Payment' table. You can move, or remove it, as needed.
            this.paymentTableAdapter.Fill(this.myDatabaseProjectDataSet.Payment);
